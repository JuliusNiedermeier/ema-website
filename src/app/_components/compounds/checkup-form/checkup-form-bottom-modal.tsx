...
export type CheckupFormBottomModalProps = ComponentProps<typeof Drawer.Portal> & {
  heading: string;
  resultCounter: Pick<ComponentProps<typeof ResultCounter>, "singularSuffix" | "pluralSuffix">;
};

export const CheckupFormBottomModal: FC<CheckupFormBottomModalProps> = ({ heading, resultCounter, ...restProps }) => {
  return (
